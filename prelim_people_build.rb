  ...
  module People
    ...
    @people_job = Kiba.parse do
      ...
      @acqsrc = Lookup.csv_to_multi_hash(file: "#{DATADIR}/mimsy/acquisition_sources.tsv",
                                         csvopt: TSVOPT,
                                         keycolumn: :link_id)
      @dispsrc = Lookup.csv_to_multi_hash(file: "#{DATADIR}/mimsy/disposal_sources.tsv",
                                          csvopt: TSVOPT,
                                          keycolumn: :link_id)
      ...
      transform Merge::MultiRowLookup,
        ...
        constantmap: {
          :disp_termPrefForLangNonPreferred => 'false',
      ...
      transform CombineValues::FromFieldsWithDelimiter,
        sources: [:ac_occupation, :disp_occupation, :ip_occupation, :im_relationship, :im_affiliation],
        target: :group,
        sep: MVDELIM
      ...
      transform CombineValues::FromFieldsWithDelimiter,
        sources: [:contactName, :ac_contactName, :disp_contactName, :ip_contactName],
        target: :contactName,
        sep: MVDELIM
      ...
      transform CombineValues::FromFieldsWithDelimiter,
        sources: [:termDisplayNameNonPreferred, :ac_variant, :disp_variant, :ip_variant, :im_variant, :sd_variant, :sd_pref],
        target: :termDisplayNameNonPreferred,
        sep: MVDELIM

      transform CombineValues::FromFieldsWithDelimiter,
        sources: [:termPrefForLangNonPreferred, :ac_termPrefForLangNonPreferred, :disp_termPrefForLangNonPreferred, :ip_termPrefForLangNonPreferred, :im_termPrefForLangNonPreferred, :sd_var_termPrefForLangNonPreferred, :sd_pref_termPrefForLangNonPreferred],
        target: :termPrefForLangNonPreferred,
        sep: MVDELIM

      transform CombineValues::FromFieldsWithDelimiter,
        sources: [:termSourceLocalNonPreferred, :ac_termSourceLocalNonPreferred, :disp_termSourceLocalNonPreferred, :ip_termSourceLocalNonPreferred, :im_termSourceLocalNonPreferred, :sd_var_termSourceLocalNonPreferred, :sd_pref_termSourceLocalNonPreferred],
        target: :termSourceLocalNonPreferred,
        sep: MVDELIM

      transform CombineValues::FromFieldsWithDelimiter,
        sources: [:termSourceDetailNonPreferred, :ac_termSourceDetailNonPreferred, :disp_termSourceDetailNonPreferred, :ip_termSourceDetailNonPreferred, :im_termSourceDetailNonPreferred, :sd_var_termSourceDetailNonPreferred, :sd_pref_termSourceDetailNonPreferred],
